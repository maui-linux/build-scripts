...
if [ -e $BUILD_DIR/packages-add.txt ]; then
	...
	exec_in_chroot "apt-get install ubiquity=2.21.23-netrunner1 ubiquity-slideshow-netrunner ubiquity-frontend-kde=2.21.23-netrunner1 ubiquity-ubuntu-artwork=2.21.23-netrunner1"
